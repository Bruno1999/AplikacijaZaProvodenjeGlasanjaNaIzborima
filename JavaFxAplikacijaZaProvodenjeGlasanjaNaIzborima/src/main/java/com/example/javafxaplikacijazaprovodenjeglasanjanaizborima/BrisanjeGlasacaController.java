...
public class BrisanjeGlasacaController {


    private static Connection connection;

    private static Glasac odabraniGlasac = null;
    ...
    public void deleteGlasac(ActionEvent event) throws SQLException, IOException {
        ...
        deleteStudent.setString(1, glasacTableView.getSelectionModel().getSelectedItem().getJmbag());
...
/*
    public void deleteGlasac() throws SQLException, IOException {

        glasacTableView.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {

            @Override
            public void handle(MouseEvent t) {
                if(t.getButton() == MouseButton.SECONDARY) {
                    odabraniGlasac=glasacTableView.getSelectionModel().getSelectedItem();
                }
                ...
                PreparedStatement deleteStudent =
                    ...
                    deleteStudent.setString(1, odabraniGlasac.getJmbag());
